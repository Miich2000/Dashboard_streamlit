...
st.markdown(f'A tabela posssui {dados_filtrados.shape[0]} linhas e {dados_filtrados.shape[1]} colunas')
...
with coluna2:
    st.download_button('Fazer download da tabela', data = converter_csv(dados_filtrados),
